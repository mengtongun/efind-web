...
const IndexPage = () => {
  return (
    <div className="p-12 border border-blue-700 rounded-md m-12">
      <CustomNextSeo title="Terms & Condition" url="https://efind.vercel.app/terms-of-service" />

      <h2 className="text-center">
        <b className="text-xl">TERMS AND CONDITIONS</b>
      </h2>
      ...
      <p>
        Welcome to <b>eFind</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at{' '}
        <b>efind.vercel.app</b> (together or individually “Service”) operated by <b>eFind</b>.
      </p>
      <p>
      ...
      <p>
        ...
        know by emailing at <b>unmengtong@gmail.com</b> so we can try to find a solution. These Terms apply to all
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at unmengtong@gmail.com.
      </p>
      ...
      <p>eFind has the right but not the obligation to monitor and edit all Content provided by users.</p>
      <p>
        In addition, Content found on or through this Service are the property of eFind or used with permission. You may
        not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in
      ...
      <p>
        ...
        remain the exclusive property of eFind and its licensors. Service is protected by copyright, trademark, and
        other laws of and foreign countries. Our trademarks may not be used in connection with any product or service
        without the prior written consent of eFind.
      </p>
      <p>
      ...
      <p>
        ...
        unmengtong@gmail.com, with the subject line: “Copyright Infringement” and include in your claim a detailed
      ...
      <p>You can contact our Copyright Agent via email at unmengtong@gmail.com.</p>
      <p>
        12. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at unmengtong@gmail.com or via third party sites and tools with information
      ...
      <p>
        Our Service may contain links to third party web sites or services that are not owned or controlled by eFind.
      </p>
      <p>
        eFind has no control over, and assumes no responsibility for the content, privacy policies, or practices of any
        third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their
        websites.
      </p>
      <p>
        For example, the outlined <a href="https://policymaker.io/terms-and-conditions/">Terms of Use</a> have been
        created using <a href="https://policymaker.io/">PolicyMaker.io</a>, a free web application for generating
        high-quality legal documents. PolicyMaker’s{' '}
        <a href="https://policymaker.io/terms-and-conditions/">Terms and Conditions generator</a> is an easy-to-use free
        tool for creating an excellent standard Terms of Service template for a website, blog, e-commerce store or app.
      </p>
      <p>
      ...
      <p>
        These Terms shall be governed and construed in accordance with the laws of Cambodia, which governing law applies
      ...
      <p>
        Please send your feedback, comments, requests for technical support by email: <b>unmengtong@gmail.com</b>.
      </p>
    </div>
  );
};
