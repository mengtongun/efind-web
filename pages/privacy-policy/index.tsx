...
const IndexPage = () => {
  return (
    <div className="border border-blue-700 rounded-md m-12 p-12">
      ...
      <p>
        Welcome to <b> eFind</b>.
      </p>
      <p>
        <b>eFind</b> (“us”, “we”, or “our”) operates <b>efind.vercel.app</b> (hereinafter referred to as{' '}
        <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>efind.vercel.app</b>, and explains how we collect, safeguard and
      ...
      <p>
        <b>SERVICE</b> means the efind.vercel.app website operated by eFind.
      </p>
      <p>
      ...
      <p>
        We may use and store information about your location if you give us permission to do so (<b>“Location Data”</b>
      ...
      <p>
        ...
        <a href="https://policymaker.io/non-disclosure-agreement/">NDA agreements</a>, information on bonuses and
      ...
      <p>eFind uses the collected data for various purposes:</p>
      ...
      <p>
        If you are located outside Cambodia and choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Cambodia and process it there.
      </p>
      <p>
      ...
      <p>
        eFind will take all the steps reasonably necessary to ensure that your data is treated securely and in
      ...
      <p>
        ...
        systems, please email us at <b>unmengtong@gmail.com</b>.
      </p>
      ...
      <p>
        0.4. users are able to change their personal information by emailing us at <b>unmengtong@gmail.com</b>.
      </p>
      ...
      <p>
        For example, the outlined <a href="https://policymaker.io/privacy-policy/">privacy policy</a> has been made
        ...
        <a href="https://policymaker.io/blog-privacy-policy/">privacy policy for blog</a>, website, e-commerce store or
        mobile app.
      </p>
      <p>
        19.{' '}
      ...
      <p>
        If you have any questions about this Privacy Policy, please contact us by email: <b>unmengtong@gmail.com</b>.
      </p>
    </div>
  );
};
